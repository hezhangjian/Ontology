...
@Component
public final class OntologyToolClient {
    private final ObjectMapper json;
    private final WebClient web;

    OntologyToolClient(WebClient.Builder builder, ObjectMapper json, AgentProperties properties) {
        this.json = json;
        this.web = builder.baseUrl(properties.coreUrl()).build();
    }
    ...
    public Object confirmAction(Map<String, Object> request, RequestContext context) {
        return post("/action-types/" + required(request, "actionId") + "/executions",
                Map.of("previewToken", required(request, "previewToken")),
                Map.of("Idempotency-Key", required(request, "idempotencyKey")), context);
    }

    @SuppressWarnings("unchecked")
    public Object confirmRuleTransform(Map<String, Object> request, RequestContext context) {
        Map<String, Object> pipeline = (Map<String, Object>) get("/pipelines/" + required(request, "pipelineId"), context);
        ...
        String beforeNodeId = required(request, "beforeNodeId");
        ...
        rule.put("field", required(request, "field"));
        rule.put("max", request.get("max"));
        rule.put("min", request.get("min"));
        rule.put("operator", request.getOrDefault("operator", "OUTSIDE_RANGE"));
        rule.put("preserveOriginalAs", request.getOrDefault("preserveOriginalAs", "raw_" + required(request, "field")));
        rule.put("replacement", request.get("replacement"));
        rule.put("statusField", request.getOrDefault("statusField", "cleaning_status"));
        ...
        Object updated = patch("/pipelines/" + required(request, "pipelineId") + "/draft",
    ...
    private Object compactQuery(Object value, Map<String, Object> arguments) {
        ...
        Map<String, Object> compact = new LinkedHashMap<>();
        for (String key : List.of("objectTypeId", "objectTypeName", "visibleCount")) {
    ...
    private Object post(String path, Object body, Map<String, String> headers, RequestContext context) { return request("POST", path, body, headers, context); }
    ...
    public record RequestContext(String ontologyId) { }
}
