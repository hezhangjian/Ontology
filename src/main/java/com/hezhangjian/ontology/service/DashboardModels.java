...
public final class DashboardModels {
    ...
    public record DashboardSummary(UUID id, String name, String description, String lifecycle,
                                   @JsonIgnore Integer currentVersion, int pageCount, int widgetCount,
    ...
    public record DashboardDetail(DashboardSummary summary, DashboardDefinition currentDefinition,
    ...
    public record DashboardDataSource(UUID id, String name, String kind, UUID objectTypeId, String datasetId,
                                      UUID referenceId, @JsonIgnore Integer referenceVersion,
    ...
    public record DashboardDraftView(UUID id, UUID dashboardId, @JsonIgnore UUID baseVersionId,
