...
class ConversationStoreTest {
    private static final String IOT = "iot_operations";
    private static final UUID IOT_INTERNAL_ID =
            UUID.fromString("00000000-0000-0000-0000-00000000a002");
    private static final String TOKEN = "token_consumption";
    private static final UUID TOKEN_INTERNAL_ID =
    ...
    void persistsMessagesAndToolTraces() {
        ...
        assertEquals(TOKEN, restored.ontologyId());
    ...
    private ConversationStore store() {
        ...
        SqlRepository jdbc = new SqlRepository(dataSource);
        ...
        OntologyLookupService ontologies = mock(OntologyLookupService.class);
        when(ontologies.resolve(TOKEN)).thenReturn(TOKEN_INTERNAL_ID);
        when(ontologies.resolve(IOT)).thenReturn(IOT_INTERNAL_ID);
        return new ConversationStore(jdbc, new ObjectMapper(), ontologies);
    }
}
