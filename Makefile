...
.PHONY: build compose-build compose-config compose-down compose-up e2e-platform-foundation e2e-storage frontend-build frontend-install frontend-lint frontend-typecheck openapi-check test verify-fast
