...
admin_api_token=$(service_token ontology-p07-e2e-admin Admin,Builder,Viewer)
builder_api_token=$(service_token ontology-p07-e2e-builder Builder,Viewer)
viewer_api_token=$(service_token ontology-p07-e2e-viewer Viewer)

for service in apisix frontend hugegraph keycloak ontology-core opensearch postgres projection-worker pulsar; do
