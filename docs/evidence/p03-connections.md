...
The executable evidence is `docker/scripts/e2e-connections.sh`. It uses real Keycloak tokens, APISIX routing, Ontology Core, PostgreSQL, Docker Secrets, and MinIO.
