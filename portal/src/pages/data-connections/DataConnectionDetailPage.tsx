...
export default function DataConnectionDetailPage({ accessToken, assetId, id, isAdmin, navigate }: Props) {
  ...
  function confirmRemove() {
    ...
    Modal.confirm({
      ...
      content: '此操作只允许已停用且无引用、无活动运行的连接。历史审计和快照仍会保留。',
