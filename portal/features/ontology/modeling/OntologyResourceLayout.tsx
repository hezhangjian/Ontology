import { ApartmentOutlined, AppstoreOutlined, CheckSquareOutlined, DashboardOutlined, FieldStringOutlined, FunctionOutlined, LinkOutlined } from '@/shared/icons';
import { Menu } from '@/shared/components/navigation';
