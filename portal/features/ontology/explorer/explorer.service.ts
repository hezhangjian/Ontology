import type { CapabilityResponse, ExplorerHome, ExplorationView, ExportJob, ObjectDetail, ObjectListView, ObjectSetPage, ObjectSetRequest, RelationGraph, SearchResponse } from './explorer.types';
...
export class ExplorerApi {
  ...
  relationGraph = (roots: Array<{ objectTypeId: string; objectId: string }>, hops = 1) => this.request<RelationGraph>('/object-sets/relation-graph', { method: 'POST', body: JSON.stringify({ direction: 'BOTH', hops, linkTypeIds: [], roots }) });
