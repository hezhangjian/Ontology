import { ArrowRightOutlined, DatabaseOutlined, FolderOpenOutlined, SearchOutlined, UnorderedListOutlined } from '@/shared/icons';
import { Button, Tag } from '@/shared/components/actions';
import { List, Table } from '@/shared/components/data';
import { Alert, Empty, Skeleton, Statistic } from '@/shared/components/feedback';
